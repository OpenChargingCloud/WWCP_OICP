...
namespace cloud.charging.open.protocols.OICPv2_3.CPO
{
    ...
    /// </summary>
    public class CPOServerAPIHTTPClientLogger : HTTPClientLogger
    {
        ...
        #region CPOServerAPIHTTPClientLogger (CPOServerAPIClient, Context = DefaultContext, LogfileCreator = null)
        ...
        public CPOServerAPIHTTPClientLogger(CPOServerAPIClient       CPOServerAPIClient,
                                            String?                  LoggingPath,
        ...
        #region CPOServerAPIHTTPClientLogger (CPOServerAPIClient, Context, ... Logging delegates ...)
