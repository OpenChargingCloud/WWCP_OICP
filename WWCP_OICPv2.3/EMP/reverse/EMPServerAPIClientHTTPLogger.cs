...
namespace cloud.charging.open.protocols.OICPv2_3.EMP
{
    ...
    /// </summary>
    public class EMPServerAPIHTTPClientLogger : HTTPClientLogger
    {
        ...
        #region EMPServerAPIHTTPClientLogger (EMPServerAPIClient, Context = DefaultContext, LogfileCreator = null)
        ...
        public EMPServerAPIHTTPClientLogger(EMPServerAPIClient       EMPServerAPIClient,
                                            String?                  LoggingPath,
        ...
        #region EMPServerAPIHTTPClientLogger (EMPServerAPIClient, Context, ... Logging delegates ...)
