...
namespace cloud.charging.open.protocols.OICPv2_3.EMP
{
    ...
    public partial class EMPClient
    {
        ...
        public class HTTP_Logger : HTTPClientLogger
        {
            ...
            #region HTTP_Logger(EMPClient, Context = DefaultContext, LogfileCreator = null)
            ...
            public HTTP_Logger(EMPClient                EMPClient,
            ...
            #region HTTP_Logger(EMPClient, Context, ... Logging delegates ...)
