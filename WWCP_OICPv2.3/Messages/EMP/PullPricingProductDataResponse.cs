...
namespace cloud.charging.open.protocols.OICPv2_3
{
                                                  ...
                                                  PullPricingProductDataResponse>
    {
        ...
        public PullPricingProductDataResponse(PullPricingProductDataRequest    Request,
                                       ...
                                       CustomJObjectParserDelegate<PullPricingProductDataResponse>?  CustomPullPricingProductDataResponseParser   = null)
        {
            ...
            try
            {
                ...
                foreach (var evseDataRecordJSON in PricingProductDataJSON)
                {
                    ...
                    try
                    {
                        ...
                        if (evseDataRecordJSON is JObject evseDataRecordJObject &&
                            OICPv2_3.PricingProductData.TryParse(evseDataRecordJObject,
                ...
                PullPricingProductDataResponse = new PullPricingProductDataResponse(Request,
                                                                                    ResponseTimestamp,
                                                                                    EventTrackingId,
                                                                                    Runtime,
                                                                                    PricingProductData,
