...
namespace org.GraphDefined.WWCP.OICPClient_1_2
{
    ...
    public static class OICPNS
    {
        ...
        /// </summary>
        public static readonly XNamespace CommonTypes          = "http://www.hubject.com/b2b/services/commontypes/v1.2";

        /// <summary>
        /// The namespace for the EVSE Data within the Open Intercharge Protocol (OICP) Version 2.0.
        /// </summary>
        public static readonly XNamespace EVSEData             = "http://www.hubject.com/b2b/services/evsedata/v1.2";

        /// <summary>
        /// The namespace for the EVSE Status within the Open Intercharge Protocol (OICP) Version 2.0.
        /// </summary>
        public static readonly XNamespace EVSEStatus           = "http://www.hubject.com/b2b/services/evsestatus/v1.2";

        /// <summary>
        /// The namespace for the Authorization within the Open Intercharge Protocol (OICP) Version 2.0.
        /// </summary>
        public static readonly XNamespace Authorization        = "http://www.hubject.com/b2b/services/authorization/v1.2";

        /// <summary>
        /// The namespace for the Mobile Authorization within the Open Intercharge Protocol (OICP) Version 2.0.
        /// </summary>
        public static readonly XNamespace MobileAuthorization  = "http://www.hubject.com/b2b/services/mobileauthorization/v1.2";

        /// <summary>
        /// The namespace for EVSE Serach within the Open Intercharge Protocol (OICP) Version 2.0.
        /// </summary>
        public static readonly XNamespace EVSESearch           = "http://www.hubject.com/b2b/services/evsesearch/v1.2";
