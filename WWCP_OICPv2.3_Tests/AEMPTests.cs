...
namespace cloud.charging.open.protocols.OICPv2_3.EMP.tests
{
    ...
    public abstract class AEMPTests
    {
        ...
        public async Task SetupEachTest()
        {
            ...
            empServerAPI.OnAuthorizeStart += (timestamp, sender, authorizationStartRequest) => {

                if (authorizationStartRequest.Identification is not null)
                {


                    if (authorizationStartRequest.Identification.RFIDId is not null)
                    {
                        return authorizationStartRequest.Identification.RFIDId.ToString() switch
                        {

                            "AABBCCDD" => Task.FromResult(AuthorizationStartResponse.Authorized   (Request:                           authorizationStartRequest,
                                                                                                   SessionId:                         authorizationStartRequest.SessionId,
                                                                                                   CPOPartnerSessionId:               authorizationStartRequest.CPOPartnerSessionId,
                                                                                                   EMPPartnerSessionId:               authorizationStartRequest.EMPPartnerSessionId,
                            ...
                            _          => Task.FromResult(AuthorizationStartResponse.NotAuthorized(Request:                           authorizationStartRequest,
                    ...
                    if (authorizationStartRequest.Identification.RFIDIdentification is not null)
                    {
                        return authorizationStartRequest.Identification.RFIDIdentification.UID.ToString() switch
                        {
                ...
                return Task.FromResult(AuthorizationStartResponse.DataError     (Request:                           authorizationStartRequest,
                                                                                 StatusCodeDescription:             "authorizationStartRequest.Identification is null!",
                                                                                 StatusCodeAdditionalInfo:          null,
                                                                                 SessionId:                         authorizationStartRequest.SessionId,
                                                                                 CPOPartnerSessionId:               authorizationStartRequest.CPOPartnerSessionId,
                                                                                 EMPPartnerSessionId:               authorizationStartRequest.EMPPartnerSessionId,
