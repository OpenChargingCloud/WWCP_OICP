...
//                              MeterValuesInBetween:   [ WattHour.FromKWh(4), WattHour.FromKWh(5), WattHour.FromKWh(6) ],
...
//                              SessionStart:             DateTimeOffset.Parse("2022-08-09T10:18:25.229Z"),
//                              ConsumedEnergyProgress:   WattHour.FromKWh(5),
//                              MeterValueStart:          WattHour.FromKWh(3),
//                              MeterValuesInBetween:     [ WattHour.FromKWh(4), WattHour.FromKWh(5) ],
//                              OperatorId:               Operator_Id.Parse("DE*GEF"),
//                              PartnerProductId:         PartnerProduct_Id.AC1,
