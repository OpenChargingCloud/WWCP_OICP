...
namespace cloud.charging.open.protocols.OICPv2_3.tests.CPO.client
{
    ...
    public class AuthorizeStartStopTests : ACPOClientAPITests
    {
        ...
        public async Task AuthorizeStart_Test1()
        {
            ...
            Assert.AreEqual(0, cpoClientAPI.Counters.AuthorizeStart.Requests_OK);
            Assert.AreEqual(0, cpoClientAPI.Counters.AuthorizeStart.Requests_Error);
            Assert.AreEqual(0, cpoClientAPI.Counters.AuthorizeStart.Responses_OK);
            Assert.AreEqual(0, cpoClientAPI.Counters.AuthorizeStart.Responses_Error);
            ...
            Assert.AreEqual(1, cpoClientAPI.Counters.AuthorizeStart.Requests_OK);
            Assert.AreEqual(0, cpoClientAPI.Counters.AuthorizeStart.Requests_Error);
            Assert.AreEqual(1, cpoClientAPI.Counters.AuthorizeStart.Responses_OK);
            Assert.AreEqual(0, cpoClientAPI.Counters.AuthorizeStart.Responses_Error);
        ...
        public async Task AuthorizeStop_Test1()
        {
            ...
            Assert.AreEqual(0, cpoClient.   Counters.AuthorizeStop.Requests_OK);
            Assert.AreEqual(0, cpoClient.   Counters.AuthorizeStop.Requests_Error);
            Assert.AreEqual(0, cpoClient.   Counters.AuthorizeStop.Responses_OK);
            Assert.AreEqual(0, cpoClient.   Counters.AuthorizeStop.Responses_Error);

            Assert.AreEqual(0, cpoClientAPI.Counters.AuthorizeStop.Requests_OK);
            Assert.AreEqual(0, cpoClientAPI.Counters.AuthorizeStop.Requests_Error);
            Assert.AreEqual(0, cpoClientAPI.Counters.AuthorizeStop.Responses_OK);
            Assert.AreEqual(0, cpoClientAPI.Counters.AuthorizeStop.Responses_Error);
            ...
            Assert.AreEqual(1, cpoClient.   Counters.AuthorizeStop.Requests_OK);
            Assert.AreEqual(0, cpoClient.   Counters.AuthorizeStop.Requests_Error);
            Assert.AreEqual(1, cpoClient.   Counters.AuthorizeStop.Responses_OK);
            Assert.AreEqual(0, cpoClient.   Counters.AuthorizeStop.Responses_Error);

            Assert.AreEqual(1, cpoClientAPI.Counters.AuthorizeStop.Requests_OK);
            Assert.AreEqual(0, cpoClientAPI.Counters.AuthorizeStop.Requests_Error);
            Assert.AreEqual(1, cpoClientAPI.Counters.AuthorizeStop.Responses_OK);
            Assert.AreEqual(0, cpoClientAPI.Counters.AuthorizeStop.Responses_Error);
