...
namespace cloud.charging.open.protocols.OICPv2_3.tests
{
    ...
    public class CalibrationLawVerificationTests
    {
        ...
        public void CalibrationLawVerification_ParseJSON_Test1()
        {
            ...
            var calibrationLawVerification1 = CalibrationLawVerification.Parse(new JObject(
        ...
        #region CalibrationLawVerification_ParseJSON_Test2()

        [Test]
        public void CalibrationLawVerification_ParseJSON_Test2()
        {
