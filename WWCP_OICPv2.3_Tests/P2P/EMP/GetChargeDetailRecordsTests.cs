    ...
    public class GetChargeDetailRecordsTests : AP2PTests
    {
        ...
        public async Task GetChargeDetailRecords_Empty()
        {
            ...
            if (empP2P_DEGDF.GetEMPClient(DEGEF_Id) is EMPClient empClient)
            {
                ...
                Assert.AreEqual(0, cpoP2P_DEGEF.EMPClientAPI.Counters.GetChargeDetailRecords.Requests_OK);
                Assert.AreEqual(0, cpoP2P_DEGEF.EMPClientAPI.Counters.GetChargeDetailRecords.Requests_Error);
                Assert.AreEqual(0, cpoP2P_DEGEF.EMPClientAPI.Counters.GetChargeDetailRecords.Responses_OK);
                Assert.AreEqual(0, cpoP2P_DEGEF.EMPClientAPI.Counters.GetChargeDetailRecords.Responses_Error);
                ...
                Assert.AreEqual(1, cpoP2P_DEGEF.EMPClientAPI.Counters.GetChargeDetailRecords.Requests_OK);
                Assert.AreEqual(0, cpoP2P_DEGEF.EMPClientAPI.Counters.GetChargeDetailRecords.Requests_Error);
                Assert.AreEqual(1, cpoP2P_DEGEF.EMPClientAPI.Counters.GetChargeDetailRecords.Responses_OK);
                Assert.AreEqual(0, cpoP2P_DEGEF.EMPClientAPI.Counters.GetChargeDetailRecords.Responses_Error);
