...
namespace cloud.charging.open.protocols.OICPv2_3.tests.P2P.CPO
{
    ...
    /// </summary>
    [TestFixture]
    public class PushEVSEDataAndStatusTests : AP2PTests
    {
        ...
        public async Task PushEVSEData_Minimal1()
        {
            ...
            if (cpoP2P_DEGEF.GetCPOClient(DEGDF_Id) is CPOClient cpoClient)
            {
                ...
                ClassicAssert.AreEqual(0, empP2P_DEGDF.CPOClientAPI.Counters.PushEVSEData.Requests_OK);
                ClassicAssert.AreEqual(0, empP2P_DEGDF.CPOClientAPI.Counters.PushEVSEData.Requests_Error);
                ClassicAssert.AreEqual(0, empP2P_DEGDF.CPOClientAPI.Counters.PushEVSEData.Responses_OK);
                ClassicAssert.AreEqual(0, empP2P_DEGDF.CPOClientAPI.Counters.PushEVSEData.Responses_Error);


                var oicpResult  = await cpoP2P_DEGEF.PushEVSEData(Provider_Id.Parse("DE*GDF"), request);
                ...
                ClassicAssert.AreEqual(1, empP2P_DEGDF.CPOClientAPI.Counters.PushEVSEData.Requests_OK);
                ClassicAssert.AreEqual(0, empP2P_DEGDF.CPOClientAPI.Counters.PushEVSEData.Requests_Error);
                ClassicAssert.AreEqual(1, empP2P_DEGDF.CPOClientAPI.Counters.PushEVSEData.Responses_OK);
                ClassicAssert.AreEqual(0, empP2P_DEGDF.CPOClientAPI.Counters.PushEVSEData.Responses_Error);
        ...
        public async Task PushEVSEStatus_Test1()
        {
            ...
            if (cpoP2P_DEGEF.GetCPOClient(DEGDF_Id) is CPOClient cpoClient)
            {
                ...
                ClassicAssert.AreEqual(0, empP2P_DEGDF.CPOClientAPI.Counters.PushEVSEStatus.Requests_OK);
                ClassicAssert.AreEqual(0, empP2P_DEGDF.CPOClientAPI.Counters.PushEVSEStatus.Requests_Error);
                ClassicAssert.AreEqual(0, empP2P_DEGDF.CPOClientAPI.Counters.PushEVSEStatus.Responses_OK);
                ClassicAssert.AreEqual(0, empP2P_DEGDF.CPOClientAPI.Counters.PushEVSEStatus.Responses_Error);


                var oicpResult  = await cpoP2P_DEGEF.PushEVSEStatus(Provider_Id.Parse("DE*GDF"), request);
                ...
                ClassicAssert.AreEqual(1, empP2P_DEGDF.CPOClientAPI.Counters.PushEVSEStatus.Requests_OK);
                ClassicAssert.AreEqual(0, empP2P_DEGDF.CPOClientAPI.Counters.PushEVSEStatus.Requests_Error);
                ClassicAssert.AreEqual(1, empP2P_DEGDF.CPOClientAPI.Counters.PushEVSEStatus.Responses_OK);
                ClassicAssert.AreEqual(0, empP2P_DEGDF.CPOClientAPI.Counters.PushEVSEStatus.Responses_Error);
