...
namespace cloud.charging.open.protocols.OICPv2_3.tests.EMP.client
{
    ...
    public class PullPricingDataTests : AEMPClientAPITests
    {
        ...
        public async Task PullPricingProductData_Test_Empty()
        {
            ...
            ClassicAssert.AreEqual(0, empClientAPI.Counters.PullPricingProductData.Requests_OK);
            ClassicAssert.AreEqual(0, empClientAPI.Counters.PullPricingProductData.Requests_Error);
            ClassicAssert.AreEqual(0, empClientAPI.Counters.PullPricingProductData.Responses_OK);
            ClassicAssert.AreEqual(0, empClientAPI.Counters.PullPricingProductData.Responses_Error);
            ...
            ClassicAssert.AreEqual(1, empClientAPI.Counters.PullPricingProductData.Requests_OK);
            ClassicAssert.AreEqual(0, empClientAPI.Counters.PullPricingProductData.Requests_Error);
            ClassicAssert.AreEqual(1, empClientAPI.Counters.PullPricingProductData.Responses_OK);
            ClassicAssert.AreEqual(0, empClientAPI.Counters.PullPricingProductData.Responses_Error);
        ...
        public async Task PullEVSEPricing_Test_Empty()
        {
            ...
            ClassicAssert.AreEqual(0, empClientAPI.Counters.PullEVSEPricing.Requests_OK);
            ClassicAssert.AreEqual(0, empClientAPI.Counters.PullEVSEPricing.Requests_Error);
            ClassicAssert.AreEqual(0, empClientAPI.Counters.PullEVSEPricing.Responses_OK);
            ClassicAssert.AreEqual(0, empClientAPI.Counters.PullEVSEPricing.Responses_Error);
            ...
            ClassicAssert.AreEqual(1, empClientAPI.Counters.PullEVSEPricing.Requests_OK);
            ClassicAssert.AreEqual(0, empClientAPI.Counters.PullEVSEPricing.Requests_Error);
            ClassicAssert.AreEqual(1, empClientAPI.Counters.PullEVSEPricing.Responses_OK);
            ClassicAssert.AreEqual(0, empClientAPI.Counters.PullEVSEPricing.Responses_Error);
        ...
        public async Task PullEVSEPricing_Test1()
        {
            ...
            ClassicAssert.AreEqual (PartnerProduct_Id.Parse("AC1"),      evsePricing1?.EVSEIdProductList.FirstOrDefault());
            ...
            ClassicAssert.AreEqual (PartnerProduct_Id.Parse("AC3"),      evsePricing2?.EVSEIdProductList.FirstOrDefault());
