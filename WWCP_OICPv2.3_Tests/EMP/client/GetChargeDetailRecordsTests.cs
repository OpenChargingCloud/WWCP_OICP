...
//            ClassicAssert.AreEqual(0, empClientAPI.Counters.GetChargeDetailRecords.Requests_OK);
//            ClassicAssert.AreEqual(0, empClientAPI.Counters.GetChargeDetailRecords.Requests_Error);
//            ClassicAssert.AreEqual(0, empClientAPI.Counters.GetChargeDetailRecords.Responses_OK);
//            ClassicAssert.AreEqual(0, empClientAPI.Counters.GetChargeDetailRecords.Responses_Error);
...
//            ClassicAssert.AreEqual(1, empClientAPI.Counters.GetChargeDetailRecords.Requests_OK);
//            ClassicAssert.AreEqual(0, empClientAPI.Counters.GetChargeDetailRecords.Requests_Error);
//            ClassicAssert.AreEqual(1, empClientAPI.Counters.GetChargeDetailRecords.Responses_OK);
//            ClassicAssert.AreEqual(0, empClientAPI.Counters.GetChargeDetailRecords.Responses_Error);
...
//            ClassicAssert.IsTrue  (cdr?.MeterValuesInBetween?.Contains(WattHour.FromKWh(4)));
//            ClassicAssert.IsTrue  (cdr?.MeterValuesInBetween?.Contains(WattHour.FromKWh(5)));
//            ClassicAssert.IsTrue  (cdr?.MeterValuesInBetween?.Contains(WattHour.FromKWh(6)));
