...
namespace org.GraphDefined.WWCP.OICP_1_2
{
    ...
    public static class CPO_XMLMethods
    {
        ...
        internal static XElement ToXML(this EVSEDataRecord EVSEDataRecord)
        {
            ...
            return new XElement(OICPNS.EVSEData + "EvseDataRecord",
                ...
                new XElement(OICPNS.EVSEData + "Address",
                    ...
                    new XElement(OICPNS.CommonTypes + "Street",         EVSEDataRecord.Address.Street), // OICPv1.2 requires at least 5 characters!
        ...
        /// <summary>
        /// Create an OICP v1.2 Authorize Start XML request.
        /// </summary>
        ...
        /// <summary>
        /// Create an OICP v1.2 Authorize Stop XML request.
        /// </summary>
        /// <param name="EVSE">An EVSE.</param>
